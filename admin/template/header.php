...
$user = new User;
!$user->isAdmin() ? header("location: $config[app_url]") : null;
?>
<!DOCTYPE html>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="<?php echo $config['admin_assets'] ?>img/sidebar-5.jpg" data-color="black">
            <!--
        Tip 1: You can change the color of the sidebar using: data-color="purple | blue | green | c | red"
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="<?php echo $config['app_url'] ?>admin/">
                        <?php echo $title ?> </a>
                    <button href="" class="navbar-toggler navbar-toggler-sright" type="button" data-toggle="collapse"
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="#pablo">
                                    <span class="no-icon"><?php echo $user->userName() ?></span>
                                </a>
                            </li>
